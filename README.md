...
* [Intrusion Detection System Based on the Analysis of Time Intervals of CAN Messages](https://pure.korea.ac.kr/en/publications/intrusion-detection-system-based-on-the-analysis-of-time-interval/) - Song, Kim, and Kim, ICOIN 2016. Lightweight IDS showing message period alone separates injection attacks from normal CAN traffic.
* [Entropy-based Anomaly Detection for In-Vehicle Networks](https://www.semanticscholar.org/paper/Entropy-based-anomaly-detection-for-in-vehicle-M%C3%BCter-Asaj/7e0e23218cfad13c0efb6a506bbc44a6ddbace3a) - Muter and Asaj, IEEE Intelligent Vehicles Symposium 2011. Introduced entropy of CAN traffic as an anomaly signal, the earliest widely cited in-vehicle IDS proposal.
